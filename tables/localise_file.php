 ...
 * @subpackage	Localise
 */
class LocaliseFileTableLocalise extends JTable
{
	/**
	 * Primary Key
	 *
	...
	{
		$k = $this->_tbl_key;
		return 'com_localise_file.' . (int)$this->$k;
	}
	...
	protected function _getAssetParentId($table = null, $id = null) 
	{
		...
		$parentPath = dirname($this->path) . substr($name,0,5) . ".xml";
		
		return LocaliseHelper::getFileAssetId($parentPath);
	}
